package com.shulan.hn.simplegank.model.zhihu;
...
public class TestDemo implements Parcelable {
    ...
    protected TestDemo(Parcel in) {
        ...
        this.top_stories = new ArrayList<StoriesBean>();
        in.readList(this.top_stories, StoriesBean.class.getClassLoader());
    }
